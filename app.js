...
// cache using local storage {Additional part}
...
function fillBio(bio) {
    // use 'pre' Tag for showing whole part of user's Bio {Additional part}
...
async function fetchProfile(event) {
    ...
    try {
        ...
        // check user exist in cache(local storage) or not
